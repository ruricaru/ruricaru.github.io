...
My primary research field is *bioinformatics*, with a particular focus on modeling and analyzing large-scale biological data, specifically omics data, which is characterized by its massive size and heterogeneity.
...
Since 2022, I co-lead the [Systems and Data research department](https://www.labri.fr/en/systems-and-data-department) composed of the [BKB](https://www.labri.fr/en/bench-knowledge-and-beyond), the [Progress](https://www.labri.fr/en/programming-networks-and-systems) and the [NeS](https://nes.labri.fr/en/) teams at the [LaBRI](http://www.labri.fr).
